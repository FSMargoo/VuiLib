...
namespace VSS {
    ...
    private:
        std::map<std::wstring, VSSSelectorProperty> ParserProperty(const std::wstring& PropertyString, VSSParserResult* Result);
    ...
    public:
        VSSParser(const std::wstring& VSString, VVVSParserParseMode VVSParserMode = VVVSParserParseMode::FromString, const int& Line = 0);
        ~VSSParser();
