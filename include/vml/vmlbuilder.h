...
namespace VML {
    ...
    protected:
        ...
        void AnalyzeProperty(const VMLFinder& RootFinder, Core::VTextSizeLayout* Object, std::map<std::wstring, VMLPropertyValue>& PropertyValueList,
                             VMLControlBuildStatus* BuildStatus);

    public:
        VMLTextSizeLayoutBuilder(const VMLFinder& RootFinder, Core::VTextSizeLayout* Object, std::map<std::wstring, VMLPropertyValue>& PropertyValueList,
                              VMLControlBuildStatus* BuildStatus);
    };
    ...
    protected:
        void Builder(Core::VLineEditor* LineEditor, const std::wstring& PlaneText, const std::wstring& LeadText);
    ...
    protected:
        void Builder(Core::VEditor* Editor, const std::wstring& PlaneText, const std::wstring& LeadingText, const int& DeltaY, const bool& AllowEdit, const bool& AllowDragFontSizeChange,
