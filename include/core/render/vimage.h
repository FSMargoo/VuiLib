 ...
 * Author		: Margoo
 * Date			: 11/12/2022
 * Description	: This head provide a image object for vuilib's renderer
*/
#pragma once
	...
	class VImage {
	 public:
		 ...
		 */
		  ...
		  *		Description : The constructor of class VImage
		  *		Values Tip	: {
		  *			[const int&			 ] Width		: The width of image surface
		  * 		[const int&			 ] Height		: The height of image surface
		  *  		[const VRenderHandle&] RenderHandle : The height of image surface
		  *		}
		 */
		  ...
		  *			[const int&				 ] Width		: The width of image surface
		  * 		[const int&				 ] Height		: The height of image surface
		  * 		[const VSurfaceAlphaMode&] AlphaMode    : The alpha mode of surface
		  *  		[const VRenderHandle&	 ] RenderHandle : The height of image surface
		  *		}
		 */
		  ...
		  *		Description : The constructor of class VImage
		  *		Values Tip	: {
		  *			[const std::wstring&] Width		: The width of image surface
		  *  		[const VRenderHandle&	 ] RenderHandle : The height of image surface
		  *		}
		 */
		  ...
		  *		}
		  *		Tips		: In general, we do not recommend that users use this constructor to
		 *					  construct a VBitmapBrush directly for the API Compatibility
		 */
		 ...
		 */
	     void ApplyShadowEffect(const float& ShadowRadius, const VColor& ShadowColor, const VRenderHandle& RenderHandle, VPoint* Offset = nullptr);

		 /*
		  * GetPixel function:
		  *		Description : This function will get the target pixel's color data
		  *					  and return as the VColor object
		  *		Tips		: The X, Y parameter should be a valid parameter shouldn't be a invalid value like negative
		 */
	     VColor GetPixel(const int& X, const int& Y, const VRenderHandle& RenderHandle) const;
	
		 /*
		  * IsValidBitmapFile function:
		  *		Description : This function will judge the target file is a valid picture,
		  *					  if the function is valid, return true, nor return false
		  *		Tips		: The function's way to judge the file's legality is try to load the
		  *					  file, if there exist any wrong while loading, the function will return false,
