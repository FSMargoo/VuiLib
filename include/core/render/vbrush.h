 ...
 * Author		: Margoo
 * Date			: 11/11/2022
 * Description	: This head defines the brush class in vuilib's renderer
 */
#pragma once
...
public:
	 ...
	 *		Tips		: If a invalid render handle is specified, the function will throw a CRT debug exception
	 *		Values Tip	: {
	 *			[const VColor&       ] Color		 : The border color
	 *			[const VRenderHandle&] RenderHandle  : The render handle of renderer
	 *			[const float&		 ] LineThickness : The border thickness <- optional
	 *		}
	 */
...
public:
	 ...
	 *	Tips		: If a negative value or zero value is specified, the function will throw a CRT debug exception
	 */
...
public:
	 ...
	 *		Tips		: If a invalid render handle is specified, the function will throw a CRT debug exception
	 *		Values Tip	: {
	 *			[const VColor&       ] Color		 : The fill color
	 *			[const VRenderHandle&] RenderHandle  : The render handle of renderer
	 *		}
	 */
...
public:
	 ...
	 *		Tips		: If a invalid render handle is specified, the function will throw a CRT debug exception
	 *		Values Tip	: {
	 *			[VImage*			 ] Image		 : A image which is specified to fill
	 *			[const VRenderHandle&] RenderHandle  : A render handle of renderer
	 *		}
	 */
	 ...
	 * VBitmapBrush constructor:
	 *		Description : The constructor of class VBitmapBrush
	 *		Tips		: 1> If a invalid render handle is specified, the function will throw a CRT debug exception
	 *					  2> If a VBitmapBrush is constructed from this constructor, this means that this is a helper
	 *class 3> In general, we do not recommend that users use this constructor to construct a VBitmapBrush directly for
	 *the API Compatibility Values Tip	: { [ID2D1Bitmap*		 ] Image		 : A image which is specified to fill
	 *			[const VRenderHandle&] RenderHandle  : A render handle of renderer
	 *		}
	 */
