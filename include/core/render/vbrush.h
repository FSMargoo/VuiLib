	...
	*/
	class VBitmapBrush {
	 public:
		 ...
		 *					  2> If a VBitmapBrush is constructed from this constructor, this means that this is a helper class
		 *					  3> In general, we do not recommend that users use this constructor to 
		 *						 construct a VBitmapBrush directly for the API Compatibility
		 *		Values Tip	: {
		 *			[ID2D1Bitmap*		 ] Image		 : A image which is specified to fill
		 *			[const VRenderHandle&] RenderHandle  : A render handle of renderer
		 *		}
		*/
