...
namespace Core {
	...
	*/
	VRENDER_HELPER class VDCRender {
	 public:
		 VDCRender(ID2D1Factory* DirectXFactory, const HDC& TargetDC, const VRect& DCRectangle, const bool& GDIMode = false, const bool& HardwareAcceleration = true) VRENDER_HELPER;
		 ~VDCRender();
