 ...
 * Date			: 11/21/2022
 * Description
 * : This head defines the basic class in vuilib - VUIObject
 */
#pragma once
 ...
 *  Description : This structure mainly log the visually irrelevant properties
 *
 * of a object
 */
struct VUIObjectKernel
{
	...
	/*
   * ParentID variable:
   *  Description : The id of this object (Relative to parent's vector container
   *
	 * size) Tips        : This variable isn't unchanged, it will change
   * dynamically, when the parent's
	 * ChildObjectContainer variable changed,
   * generally, its value changes, except for new objects were queued
	 ...
	 *
	 * Tips        : It is same as ParentID, the GlobalID isn't unchanged, it
	...
	/*
	 * Effect variable:
	 *	Description : The effect of object
	 */
	VBasicEffect *Effect;
...
struct VUIObjectShadowProperty
{
	 ...
	 *  Tips        : The Offset's
	 * value mean the shadow effect image's render
	 * position, attention, this position is relative to the
	 * position of object
	 */
	VPoint Offset;
	 ...
	 *  Tips        : This value can't be a
	 * invalid value like negative number
	 */
	float Radius;
	 ...
	 *  Tips        : If the
	 * value is true, the shadow will be enabled,
	 *                if the value is false, the shadow will be
	 * disabled
	 */
	bool EnableStatus;
...
struct VUIObjectSurface
{
	 ...
	 *  Description : The transparency of the object, if the transparency of a
	 *
	 * VUIObject is 0, it won't take part in any message's dealing which will
	 * cause repaint event
	 */
	float Transparency;
...
public:
	 ...
	 *
	 * Tips        : The return value of this function will effect the paint
	 * of child objects
	 */
	 ...
	 *     Tips :
	 * It will return the window handle of this object's widget
	 * parent
	 */
...
public:
	 ...
	 *     Tips : If
	 * the stats value is true, it will enable shadow effect,
	 *                   if the value is false, it will
...
public:
	/*
	 * InFocus signal:
	 *     Description : This signal will be triggered, if the object got mouse's
	 *
	 * focus
	 */
	VSignal<> InFocus;
	/*
	 * LostFocus signal:
	 *     Description ; If the object lost the mouse's focus, this signal will be
	 *
	 * triggered
	 */
	VSignal<> LostFocus;
...
protected:
	 ...
	 *     Description : Restore the mouse message's parameter to a point
	 * which is
...
protected:
	 ...
	 *     Description : The function will call the widget to set the
	 * global focus
	 * object's id
	 */
	 ...
	 * global
	 * focus object's id Tips        : If this function be called, the object's
	 * focus status won't
	 * be changed though whatever operation user do
	 */
	virtual void CallWidgetLockFocusID();
	/*
	 * CallWidgetUnlockFocusID function:
	 *     Description : The function will call the widget to unlock the
	 * global
	 * focus object's id
	 */
	 ...
	 *     Description : The function will call the widget send message to
	 * every
	 * object
	 */
	 ...
	 *     Description : The function will get the win32 window handle of
	 * parent
	 * widget
	 */
...
public:
	 ...
	 *     Description : The function will call the widget to
	 * get the render
	 * handle
	 */
	 ...
	 *     Description : The function will call the widget to get
	 * the render
	 * handle
	 */
...
protected:
	 ...
	 *     Description : The function will call the widget to get the canvas
	 * of
	 * parent widget
	 */
...
protected:
	 ...
	 *     Description : If a message will be sent to child object, this
	 * function
...
public:
	...
	/*
	 * EditCanvas function:
	 *     Description : This function is provided to do some operation of a
	 *
	 ...
	 *     Description : When a repaint message triggered, this function will
	 * be
	 * called
	 */
...
public:
	 ...
	 *     Description : If the object got the focus from mouse, this message
	 * will
	 * be triggered
	 */
   ...
   *     Description : If the mouse's left key clicked, the function will be
   ...
   */
	 ...
	 *     Description : If the mouse's right key clicked, the function will
	 * be
	 * called
	 */
	...
	/*
	 * MouseRightClicked function:
	 *     Description : If the mouse's middle key dragged, the function will
	 * be
	 * called
	 */
	...
	/*
	 * CheckDown function:
	 *     Description : If a key was pressed (down or up), this function will be
	 *
	 * called Tips        : If the function's return value is false, this object's
   ...
   *     Description : If a IME message was triggered, the function will be
...
public:
	/*
	 * OnMessage function:
	 *     Description : When a object received a message, this function will be
	 *
	 * called
	 */
   ...
   */
	 ...
	 *                   return value is true, the window will
	 * be closed,
...
protected:
	 ...
	 *     Tips : If
	 * the BreakWhenMeetTrue value is true, the message's
	 * sending will be break when a child object's
	 * SysProcessMessage function
	 * return true
	 */
	 ...
	 *     Description : Check the object's focus status by a specified point
	 * with
	 * a message
	 */
	 ...
	 *     Description : Check the object's element status by a specified
	 * message
	 */
...
public:
	/*
	 * SetEffect function:
	 *		Descrtiption : Set the effect of object
	 */
	void SetEffect(VBasicEffect *Effect);
