...
void VMLObject::SetNativeStyleSheet(VSS::VSSBasicSelector *Selector)
{
	...
	case VMLObjectType::TextLabel: {
		VSS::VSSVTextLabelBuilder Builder(static_cast<Core::VTextLabel *>(UIObject),
										  std::vector<VSS::VSSBasicSelector *>{Selector}, nullptr);

		break;
	}
	case VMLObjectType::ImageLabel: {
		VSS::VSSVImageLabelBuilder Builder(static_cast<Core::VImageLabel *>(UIObject),
										   std::vector<VSS::VSSBasicSelector *>{Selector}, nullptr);

		break;
	}
	case VMLObjectType::RadioButton: {
		VSS::VSSVRadioButtonBuilder Builder(static_cast<Core::VRadioButton *>(UIObject),
											std::vector<VSS::VSSBasicSelector *>{Selector}, nullptr);

		break;
	}
	case VMLObjectType::HorizontalSlider: {
		VSS::VSSVSliderHorizontalBuilder Builder(static_cast<Core::VSliderHorizontal *>(UIObject),
												 std::vector<VSS::VSSBasicSelector *>{Selector}, nullptr);
	...
	case VMLObjectType::MainWindow: {
		VSS::VSSVMainWindowBuilder Builder(static_cast<Core::VMainWindow *>(UIObject),
										   std::vector<VSS::VSSBasicSelector *>{Selector});

		break;
	}
	case VMLObjectType::BlurLabel: {
		VSS::VSSVBlurLabelBuilder Builder(static_cast<Core::VBlurLabel *>(UIObject),
										  std::vector<VSS::VSSBasicSelector *>{Selector}, nullptr);

		break;
	}
	case VMLObjectType::IconButton: {
		VSS::VSSVIconButtonBuilder Builder(static_cast<Core::VIconButton *>(UIObject),
										   std::vector<VSS::VSSBasicSelector *>{Selector}, nullptr);

		break;
	}
	case VMLObjectType::LineEditor: {
		VSS::VSSVLineEditorBuilder Builder(static_cast<Core::VLineEditor *>(UIObject),
										   std::vector<VSS::VSSBasicSelector *>{Selector}, nullptr);

		break;
	}
	case VMLObjectType::VerticalScroller: {
		VSS::VSSVerticalScrollerBuilder Builder(static_cast<Core::VScrollerVertical *>(UIObject),
												std::vector<VSS::VSSBasicSelector *>{Selector}, nullptr);

		break;
	}
	case VMLObjectType::HorizontalScroller: {
		VSS::VSSHorizontalScrollerBuilder Builder(static_cast<Core::VScrollerHorizontal *>(UIObject),
												  std::vector<VSS::VSSBasicSelector *>{Selector}, nullptr);

		break;
	}
	case VMLObjectType::ViewLabel: {
		VSS::VSSViewLabelBuilder Builder(static_cast<Core::VViewLabel *>(UIObject),
										 std::vector<VSS::VSSBasicSelector *>{Selector}, nullptr);

		break;
	}
	case VMLObjectType::CircleView: {
		VSS::VSSCircleViewBuilder Builder(static_cast<Core::VCircleView *>(UIObject),
										  std::vector<VSS::VSSBasicSelector *>{Selector});

		break;
	}
	case VMLObjectType::PolygonView: {
		VSS::VSSPolygonViewBuilder Builder(static_cast<Core::VPolygonView *>(UIObject),
										   std::vector<VSS::VSSBasicSelector *>{Selector});

		break;
	}
	case VMLObjectType::Widget: {
		VSS::VSSVWidgetBuilder Builder(static_cast<Core::VWidget *>(UIObject),
									   std::vector<VSS::VSSBasicSelector *>{Selector});
...
void VMLObject::SetStyleSheet(VSS::VSSBasicSelector *Selector)
{
	...
	case VSS::VSSSelectorType::ClassWithFakeElementSelector: {
		if (static_cast<VSS::VSSClassWithFakeElementSelector *>(Selector)->ClassTag == VMLClass)
		{
			...
			FakeElementSelector->FakeElementTag =
				static_cast<VSS::VSSClassWithFakeElementSelector *>(Selector)->ElementTag;
	...
	case VSS::VSSSelectorType::ClassWithFakeClassAndFakeElementSelector: {
		if (static_cast<VSS::VSSClassWithFakeClassAndFakeElementSelector *>(Selector)->ClassTag == VMLClass)
		{
			...
			FakeElementWithClassSelector->FakeElementTag =
				static_cast<VSS::VSSFakeElementWithClassSelector *>(Selector)->ElementTag;
			FakeElementWithClassSelector->ClassTag =
				static_cast<VSS::VSSFakeElementWithClassSelector *>(Selector)->ClassTag;
