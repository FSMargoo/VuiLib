...
namespace VSS {
    ...
    void VSSVEditorBuilder::BuildVSSObject(Core::VEditor *TargetControl,
                                           std::vector<VSSBasicSelector *> SelectorSet,
                                           Core::VTextEditorTheme *TextEditorTheme) {
        Core::VTextEditorTheme *Theme = TextEditorTheme;
        ...
        if (TargetControl != nullptr) { TargetControl->ResetTextLayout(); TargetControl->Update(); }
    }
    VSSVEditorBuilder::VSSVEditorBuilder(Core::VEditor* TargetControl,
            std::vector<VSSBasicSelector*> SelectorSet,
            Core::VTextEditorTheme* TextEditorTheme) {
        BuildVSSObject(TargetControl, SelectorSet, TextEditorTheme);
    }
