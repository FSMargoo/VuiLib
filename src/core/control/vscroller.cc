...
void VScrollerPushButton::MouseLeftClicked(Core::VMouseClickedFlag ClickedFlag) {
    switch (ClickedFlag) {
    ...
    if (ScrollerInDragging) {
        switch (Message->GetType()) {
            case VMessageType::MouseClickedMessage: {
                ...
                if ((ClickedMessage->ClickedKey == VMouseKeyFlag::Left && ClickedMessage->ClickedMethod == VMouseClickedFlag::Up) &&
                ...
                if (!ClickedMessage->MousePosition.InsideRectangle(GetRegion()) ||
                    (ClickedMessage->ClickedKey == VMouseKeyFlag::Left && ClickedMessage->ClickedMethod == VMouseClickedFlag::Up)) {
                    ScrollerInDragging = false;
                    CallWidgetUnlockFocusID();
                    CallWidgetSendMessage(Message);
                ...
                if (ClickedMessage->MousePosition.InsideRectangle(GetRegion()) ||
                    (ClickedMessage->ClickedKey == VMouseKeyFlag::Left && ClickedMessage->ClickedMethod == VMouseClickedFlag::Down)) {
                    ScrollerDragOriginPoint = ClickedMessage->MousePosition;
...
void VScrollerPushButton::LosedMouseFocus() {
    if (!ScrollerInDragging) {
        InAnimation = true;
...
VScrollerPushButton::VScrollerPushButton(VUIObject* Parent, const VScrollerButtonType& Type) : VAbstractButton(Parent) {
    Theme = new VViewScrollerButtonTheme(*(static_cast<VViewScrollerButtonTheme*>(GetTargetTheme(VUIThemeType::VViewScrollerPushButton))));
...
VScrollerVertical::VScrollerVertical(const int& Width, const int& Height, const int& ViewHeight, VUIObject* Parent) : VAbstractButton(Parent) {
    Theme = new VViewScrollerTheme(*(static_cast<VViewScrollerTheme*>(GetTargetTheme(VUIThemeType::VViewScroller))));
    Interpolator = new VAnimationInterpolator(0.1, Theme->LocalTheme.AnimationInterpolatorType);
...
void VScrollerVertical::LosedMouseFocus() {
    InAnimation = true;
...
void VScrollerVertical::InitViewButton() {
    ...
    ScrollerButton->LoseMouseFocus.Connect(this, &VScrollerVertical::LosedMouseFocus);
...
VScrollerHorizontal::VScrollerHorizontal(const int& Width, const int& Height, VUIObject* Parent) : VAbstractButton(Parent) {
    Theme = new VViewScrollerTheme(*(static_cast<VViewScrollerTheme*>(GetTargetTheme(VUIThemeType::VViewScroller))));
    Interpolator = new VAnimationInterpolator(0.1, Theme->LocalTheme.AnimationInterpolatorType);
...
VScrollerHorizontal::VScrollerHorizontal(const int& Width, const int& Height, const int& ViewHeight, VUIObject* Parent) : VAbstractButton(Parent) {
    Theme = new VViewScrollerTheme(*(static_cast<VViewScrollerTheme*>(GetTargetTheme(VUIThemeType::VViewScroller))));
    Interpolator = new VAnimationInterpolator(0.1, Theme->LocalTheme.AnimationInterpolatorType);
...
void VScrollerHorizontal::LosedMouseFocus() {
    InAnimation = true;
