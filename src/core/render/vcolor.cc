...
VColor::VColor() :
    DxColorObject(0, 0, 0, 0) {
}
VColor::VColor(const VColor& ColorObject) :
    DxColorObject(ColorObject.DxColorObject) {
}
VColor::VColor(const ColorEnum& Color, const float& AlphaValue) :
    DxColorObject(Color, AlphaValue) {
}
VColor::VColor(const UINT32& RGB, const float& AlphaValue) :
    DxColorObject(RGB, AlphaValue) {

}
VColor::VColor(const float& R, const float& G, const float& B, const float& A) :
    DxColorObject(R, G, B, A) {
}
