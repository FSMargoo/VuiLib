...
//   create an approx fit renderer target context that will have extra space (i.e., npot)
...
//   create a new renderer target context that will reuse the prior GrSurface
