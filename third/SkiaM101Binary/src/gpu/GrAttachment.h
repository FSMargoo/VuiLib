 ...
 * texture renderer target diamond, we will merge this class with GrSurface. Until then this will
...
public:
    ...
    // are shared between multiple renderer targets at the same time. Only one usage flag may be
    // passed in.
