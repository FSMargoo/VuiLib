...
private:
    ...
    // both of these being completely orthogonal. Thus we have a total of 4 types of renderer passes.
    // We then cache a framebuffer for each type of these renderer passes.
