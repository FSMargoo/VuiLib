...
// If a curve requires at most 1 segment to renderer accurately, it's effectively a straight line.
// This feature turns on automatically ignoring those curves, with the assumption that some other
// renderer pass will produce equivalent geometry (e.g. middle-out or inner triangulations).
