...
public:
    ...
    //   ...
    //
    // The shader determines how many segments are required to renderer each individual curve
    ...
    // most complex curve in the batch to renderer smoothly (i.e., NumTrianglesAtResolveLevel() * 3).
    //
    ...
    // Uses GPU tessellation shaders to linearize, triangulate, and renderer curves.
    //
    // If PatchAttribs::kFanPoint is set, an additional triangle is added, connecting the base of
    // the curve to the fan point.
