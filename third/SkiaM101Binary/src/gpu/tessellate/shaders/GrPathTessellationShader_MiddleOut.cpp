...
//   ...
//
// The shader determines how many segments are required to renderer each individual curve smoothly,
...
// batch to renderer smoothly (i.e., NumTrianglesAtResolveLevel() * 3).
