...
public:
    ...
    // set window rectangles. It will use the provided context and renderer target to draw into, both
    ...
    // Marks the last rendered stencil mask on the renderer target context
    void finish();
