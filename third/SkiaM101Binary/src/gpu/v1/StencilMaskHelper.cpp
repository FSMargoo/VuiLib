...
// We can renderer a clip element directly without first writing to the client
...
bool StencilMaskHelper::init(const SkIRect& bounds, uint32_t genID,
    ...
    // Should have caught bounds not intersecting the renderer target much earlier in clip application
