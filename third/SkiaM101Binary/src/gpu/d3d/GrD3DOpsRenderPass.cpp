...
void GrD3DOpsRenderPass::submit() {
    ...
    // We don't use renderer passes in d3d, so there is nothing to submit here as all commands have
    // already been recorded on the main command list. If in the future we start to use renderer
