...
void GrD3DCaps::initGrCaps(const D3D12_FEATURE_DATA_D3D12_OPTIONS& optionsDesc,
    ...
    // Our renderer targets are always created with textures as the color
...
GrProgramDesc GrD3DCaps::makeDesc(GrRenderTarget* rt,
    ...
    // The num samples is already added in the renderer target key so we don't need to add it here.
