...
public:
    ...
    /**
     * If this renderer target is multisampled, this returns the MSAA texture for rendering. This
     * will be different than *this* when we have separate renderer/resolve images. If not
