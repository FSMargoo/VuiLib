 ...
 * same renderer target. It is possible that these commands execute immediately (GL), or get buffered
...
public:
    ...
    /**
     * Clear the owned renderer target. Clears the full target if 'scissor' is disabled, otherwise it
