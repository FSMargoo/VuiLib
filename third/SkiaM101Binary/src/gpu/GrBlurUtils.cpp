...
static std::unique_ptr<skgpu::v1::SurfaceDrawContext> create_mask_GPU(
    ...
    // a "SkBackingFit::kExact" size match on the actual renderer target. We do this because the
    ...
    // the same. We should offset our filter within the renderer target and expand the size as needed
