...
public:
    ...
    /** Optional extra params to renderer a partial arc rather than a full circle. */
    struct ArcParams {
...
GrOp::Owner GrOvalOpFactory::MakeOvalOp(GrRecordingContext* context,
    ...
    // Otherwise, if we have shader derivative support, renderer as device-independent
