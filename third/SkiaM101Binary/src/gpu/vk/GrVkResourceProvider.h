...
public:
    ...
    // Finds or creates a simple renderer pass that matches the target, increments the refcount,
    ...
    // Finds or creates a renderer pass that matches the target and LoadStoreOps, increments the
...
private:
    ...
    public:
        // This will always construct the basic load store renderer pass (all attachments load and
