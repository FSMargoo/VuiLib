...
public:
     ...
     * the surface is not a renderer target, otherwise it is the number of samples in the renderer
     * target.
     */
...
private:
    ...
    // We default this to 100 since we already cap the max renderer tasks at 100 before doing a
