...
"""
Create an updated VS tool

Before you can run this script, you need a collated VC tool + Windows SDK.
...
# By default the tool includes a bunch of unnecessary stuff with long path
