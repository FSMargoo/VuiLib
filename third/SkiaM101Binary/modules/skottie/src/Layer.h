...
public:
    ...
    // Attaches the actual layer content and finalizes its renderer tree.  Called once per layer.
...
private:
    ...
    sk_sp<sksg::RenderNode>    fContentTree;                // renderer tree for layer content,
