...
/**
 * Base class for nodes which can renderer to a canvas.
 */
...
public:
    ...
    // Controls the visibility of the renderer node.  Invisible nodes are not rendered,
...
protected:
    ...
    public:
        ...
        // Add (cumulative) paint overrides to a renderer node sub-DAG.
...
/**
 * Clients outside SkSG looking to implement custom renderer nodes,
