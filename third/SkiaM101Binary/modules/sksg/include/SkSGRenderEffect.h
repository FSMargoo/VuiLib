...
/**
 * Attaches a shader to the renderer DAG.
 */
...
/**
 * Attaches a mask shader to the renderer DAG.
 */
...
/**
 * Attaches an ImageFilter (chain) to the renderer DAG.
 */
...
/**
 * Applies a SkBlendMode to descendant renderer nodes.
 */
