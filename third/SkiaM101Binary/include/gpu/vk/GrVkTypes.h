 ...
 * will then execute that command buffer within a renderer pass it is using for its own draws. The
 ...
 * to renderer offscreen textures which will be sampled in draws added to the passed in
