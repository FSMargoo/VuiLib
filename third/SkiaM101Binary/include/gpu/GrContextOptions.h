...
struct SK_API GrContextOptions {
    ...
    /**
     * Disables the use of coverage counting shortcuts to renderer paths. Coverage counting can cause
    ...
    /**
     * Allow Ganesh to more aggressively reorder operations to reduce the number of renderer passes.
     * Offscreen draws will be done upfront instead of interrupting the main renderer pass when
