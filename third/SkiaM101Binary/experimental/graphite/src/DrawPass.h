 ...
 * DrawPasses are grouped into a RenderPassTask for execution within a single renderer pass if the
...
public:
    ...
    // task execution can compile necessary programs and track resources within a renderer pass.
    ...
    // has already begun a correctly configured renderer pass matching this pass's target.
