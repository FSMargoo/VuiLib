...
static DEFINE_bool(dmsaa, false, "Use internal MSAA to renderer to non-MSAA surfaces?");
...
static Window::BackendType backend_type_for_window(Window::BackendType backendType) {
    ...
    // This lets us renderer the GUI faster (and correct).
...
void Viewer::drawSlide(SkSurface* surface) {
    ...
    // By default, we renderer directly into the window's surface/canvas
    ...
    // We need to renderer offscreen if we're...
