...
__argparse.add_argument('--cc',
  action='store_true', help="allow coverage counting shortcuts to renderer paths")
...
__argparse.add_argument('--dontReduceOpsTaskSplitting',
  action='store_true', help="don't reorder GPU tasks to reduce renderer target swaps")
